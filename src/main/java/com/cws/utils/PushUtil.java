...
public class PushUtil {
    ...
    public static String push() {
        ...
        templateMessage.addData(new WxMpTemplateData("birthdays", birthdays + "", "#8A2BE2"));
        //templateMessage.addData(new WxMpTemplateData("caihongpi", CaiHongPiUtils.getCaiHongPi(),"#FF69B4"));
        templateMessage.addData(new WxMpTemplateData("tiangou",CaiHongPiUtils.getTianGou()+"","#FFC0CB"));
        templateMessage.addData(new WxMpTemplateData("zaoan",CaiHongPiUtils.getZaoan()+"","#3CB371"));
        //templateMessage.addData(new WxMpTemplateData("caiHongPi", LoveWordsUtil.getCaiHongPi(key), "#FF69B4"));
        //templateMessage.addData(new WxMpTemplateData("qinghua", CaiHongPiUtils.getQinghua() + "", "#FF69B4"));
...
//            templateMessage.addData(new WxMpTemplateData("rainbow", "***", "#00FFFF"));
//        } else {
//
...
//        }
        ...
        if (!"0".equals(weatherResult.getCode())) {
            ...
            templateMessage.addData(new WxMpTemplateData("wc_day", weather.getWc_day() + "", "#FFA500"));
            templateMessage.addData(new WxMpTemplateData("wd_day", weather.getWd_day() + "", "#FFA500"));
            templateMessage.addData(new WxMpTemplateData("high", weather.getHigh() + "", "#FF6347"));
            templateMessage.addData(new WxMpTemplateData("city", weather.getCityName() + "", "#87CEEB"));
        }
